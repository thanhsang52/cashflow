	...
	<div class="box">
		<div class="box m-b-0">
			<div class="box-header dker">
				<h3><i class="material-icons"></i> Update Account</h3>
					<small>
		...
		<div class="box b-info">
			<div class="box-body p-a-2">
				<form method="post" class="validate" autocomplete="off" action="{{ route('cashflow.accounts.update', $id) }}" enctype="multipart/form-data">
					{{ csrf_field()}}
					...
					<div class="row">
						...
						<div class="col-md-6">
						    <div class="form-group">
							    ...
							    <select class="form-control auto-select select2" data-selected="{{ $account->currency_id }}" name="currency_id" required>
									...
									{{ create_option('cashflow_currency','id','name',$account->currency_id, array('status='=>1)) }}
							    </select>
						    </div>
						</div>
						...
						<div class="col-md-6">
						    <div class="form-group">
							   ...
							   <input type="text" class="form-control float-field" name="openning_balance" value="{{ number_format( $account->openning_balance) }}" required>
						    </div>
						</div>

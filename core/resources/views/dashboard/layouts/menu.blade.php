...
<i class="material-icons">&#xe2c7;</i>
                    ...
                    @if(Helper::GeneralWebmasterSettings("cashflow_status"))
                        @if(@Auth::user()->permissionsGroup->cashflow_status)
                            <?php
                            //sang
                            $currentFolder = "cashflow"; // Put folder name here
                            $PathCurrentFolder = substr($urlAfterRoot, 0, strlen($currentFolder));
                            ?>
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a>
                                    ...
                                    <span class="nav-text">{{ __('cashflow::backend.cashflow') }}</span>
                                </a>
                                <ul class="nav-sub">
                                    ...
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.currency.index') }}">
                                            <span
                                                class="nav-text">{{__('Currency')}}</span>
                                        </a>
                                    </li>
                                    @endif
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.accounts.index') }}">
                                            <span
                                                class="nav-text">{{__('Accounts')}}</span>
                                        </a>
                                    </li>
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                    ...
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.contract.index') }}">
                                            <span
                                                class="nav-text">{{__('Contracts')}}</span>
                                        </a>
                                    </li> 
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.income.index') }}">
                                            <span
                                                class="nav-text">{{__('Income')}}</span>
                                        </a>
                                    </li> 
                                    
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.invoice.index') }}">
                                            <span
                                                class="nav-text">{{__('Invoice')}}</span>
                                        </a>
                                    </li> 
                                    <!-- <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.expense.index') }}">
                                            <span
                                                class="nav-text">{{__('Expense')}}</span>
                                        </a>
                                    </li>  -->
                                    @if(@Auth::user()->permissionsGroup->webmaster_status)
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.settings.update_settings','profile') }}">
                                            <span
                                                class="nav-text">{{__('Settings')}}</span>
                                        </a>
                                    </li> 
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.permission.index') }}">
                                            <span
                                                class="nav-text">{{ __('Access Control') }}</span>
                                        </a>
                                    </li> 
                                    @endif
                                </ul>
                    ...
                    <?php
                    //sang
                    $currentFolder = "inventory"; // Put folder name here
                    $PathCurrentFolder = substr($urlAfterRoot, 0, strlen($currentFolder));
                    ?>
                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                        <a>
                            ...
                            <span class="nav-text">{{ __('inventory::backend.inventory') }}</span>
                        </a>
                        <ul class="nav-sub">
                           
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('inventory.all') }}">
                                    <span
                                        class="nav-text">{{__('All')}}</span>
                                </a>
                            </li>
                            <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                <a href="{{ route('pos.index') }}">
                                    <span
                                        class="nav-text">{{__('POS')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                        <a href="{{ route('promotion.all') }}">
                            <span class="nav-icon">
                                <i class="material-icons">&#xe2c7;</i>
                            </span>
                            <span class="nav-text">{{ __('inventory::backend.promotion') }}</span>
                        </a>
                    </li>
                    @if(true)
                    <?php
                            //sang
                            $currentFolder = "website"; // Put folder name here
                            $PathCurrentFolder = substr($urlAfterRoot, 0, strlen($currentFolder));
                            ?>
                        <li class="nav-header hidden-folded m-t-sm">
                            <small class="text-muted">{{ __('cashflow::backend.website_crm') }}</small>
                        ...
                        <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                            <a>
                                ...
                                <span class="nav-text">{{ __('cashflow::backend.order') }}</span>
                                <ul class="nav-sub">
                                    <li {{ ($PathCurrentFolder==$currentFolder) ? 'class=active' : '' }} >
                                        <a href="{{ route('cashflow.website.order.index') }}">
                                            <span
                                                class="nav-text">{{__('All Orders')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </a>

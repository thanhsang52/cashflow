                        ...
                        <div class="b-a p-x p-t">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="checkbox">
                                        <label class="ui-check">
                                            {!! Form::checkbox('cashflow_status','1',false, array('id' => 'cashflow_status')) !!}
                                            <i class="dark-white"></i><label
                                                for="cashflow_status">{{ __('cashflow::backend.cashflow') }}</label>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="checkbox">
                                        <label class="ui-check">
                                            {!! Form::checkbox('cashflow_status','1',false, array('id' => 'cashflow_status')) !!}
                                            <i class="dark-white"></i><label
                                                for="cashflow_status">{{ __('Cashflow') }}</label>
                                        </label>
                                    </div>
                                </div>
                            </div>

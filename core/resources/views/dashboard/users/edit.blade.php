    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <label for="name"
                           class="col-sm-2 form-control-label">{!!  __('backend.branch_no') !!}
                    </label>
                    <div class="col-sm-10">
                        {!! Form::number('branch_no',$Users->branch_no, array('placeholder' => '','class' => 'form-control','id'=>'branch_no','required'=>'')) !!}
                    </div>
                </div>
